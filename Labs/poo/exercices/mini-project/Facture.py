class Facture():
    def __init__(self, id_facture, commande, total_ht, tvA, frais_service, totla_ttc): #Commande est Objet Commande associé.
    ...
    def afficher_facture(self):
        print(f"la facture de commande {self.commande}, d'id {self.id_facture}, le total hors taxes {self.total_ht}, le montant de tva {self.tvA} 
              , les frais de service {self.frais_service}, et le total ttc {self.totla_ttc}")
